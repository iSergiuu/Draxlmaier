...
import { LayoutDashboard, Users, Settings, Ticket, FileText } from 'lucide-react';
            ...
            <div className="w-64 bg-brand-sidebar text-white flex flex-col transition-colors duration-300">
                <div className="p-6">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                        {isSuperAdmin ? 'Panou Super Administrator' : 'Panou Administrator'}
                    </p>
                </div>
                ...
                <nav className="flex-1 px-4 space-y-2 mt-4">
                    ...
                    {isSuperAdmin && (
                        <>
                            ...
                            <NavLink to="/admin/reports" className={({isActive}) => `w-full flex items-center px-4 py-3 rounded-lg font-medium transition-colors ${isActive ? 'bg-brand-primary text-white' : 'text-gray-300 hover:bg-gray-800'}`}>
