    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={notifRef}>
                ...
                {isNotifOpen && (
                    <div className="absolute right-0 top-12 w-80 bg-brand-card border border-brand-border rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
